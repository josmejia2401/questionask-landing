...
const tiers = [
    {
        ...
        features: [
            'Hasta 100 formularios por usuario',
            'Hasta 1,000 respuestas por usuario',
            'Hasta 50 preguntas por formulario',
            'Hasta 20 opciones por pregunta',
        ...
        <div className="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
            ...
            <div
                className={classNames(
                    'mx-auto mt-16 grid items-center gap-y-6 sm:mt-20 sm:gap-y-0',
                    tiers.length === 1
                        ? 'max-w-xl grid-cols-1 justify-center'
                        : 'max-w-lg grid-cols-1 lg:max-w-4xl lg:grid-cols-2'
                )}
            >
